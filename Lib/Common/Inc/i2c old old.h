...
{
	void 			*pI2c;
	uint8_t			nSlaveAddr;         /* slave address    */
	uint8_t			Register;           /* I2C register to writ to  */ 
	volatile uint8_t	*pData;             /* pointer to array data    */
	uint8_t			nByte;
...
void I2cWrite(
	...
	uint8_t 		Register,
	void const 		*pData,
	uint8_t 		nByte );  /* no of bytes to write   */
